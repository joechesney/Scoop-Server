...
module.exports = () =>{
  return new Promise((resolve, reject)=>{
    let dataString = `grant_type=client_credentials&client_id=${process.env.REVERB_CLIENT_ID}&client_secret=${process.env.REVERB_CLIENT_SECRET}&scope=public+read_listings+read_orders+read_lists+write_lists+read_profile+write_profile`;
